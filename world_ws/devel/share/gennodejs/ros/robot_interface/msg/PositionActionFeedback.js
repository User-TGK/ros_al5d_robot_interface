...
let PositionFeedback = require('./PositionFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PositionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PositionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PositionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PositionActionFeedback(null);
    ...
    data.feedback = PositionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PositionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PositionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PositionFeedback()
    }
...
module.exports = PositionActionFeedback;
